...
10年的工作经历积累了丰富的经验。对各类前端技术有浓厚兴趣，对客户端和服务端领域也有涉猎，此外在技术管理和技术团队建设方面颇有心得。
...
* 博客：
  * 简书博客：[https://www.jianshu.com/u/31532ba8e13b](https://www.jianshu.com/u/31532ba8e13b)
  * 小专栏：
    * [https://xiaozhuanlan.com/etianqq](https://xiaozhuanlan.com/etianqq)
    * [https://xiaozhuanlan.com/mytalk](https://xiaozhuanlan.com/mytalk)
...
* 小海牛美港股是一款辅助投资决策的股票工具类产品。移动端为Hybird混合开发，其他PC端产品采用React框架。
  * 国际化
  * 公共网络层：网络层由Native端统一封装，Android和iOS定义相同格式的接口提供给H5页面。这样可以在HTTP接口监控，错误报警，Token失效与重置等方面，保证H5页面与原生页面完全一致，并且可以充分复用公共接口（如获取手机验证码等）。
...
* 负责前端组件化开发。
  ...
  * 组件分成：通过不断地分层将整体复杂度合理地分散在每一个模块中并将其封装起来，从而达到极大地降低拼接不同模块时复杂度的目的。
...
全部书目参考：https://www.gitbook.com/@etianqq/dashboard
...
* **工具类Web App（合作）**
  ...
  帮助朋友的在线工具网站设计用户界面: My Diary, Notebook, Notebook for Class等，涵盖在线笔记（类Evernote）， 给K12师生用的在线课堂笔记本等，广受好评，拥有20w+国外用户。项目地址:[http://www.enginestart.org/](http://www.enginestart.org/) (需代理)。 （2012年）
